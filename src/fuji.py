...
class Fuji (object):
    ...
    def __call__(self):
        #self.internal_mountain(timing=5, big_time=0.5, small_time=0.3, noise_range=3, isstop=True)
        #self.internal_mountain(timing=5, big_time=0.5, small_time=0.3, noise_range=3, isstop=False)


        #self.blue_slope(timing=3, big_time=0.5, small_time=0.3, noise_range=1, isstop=True)
        #self.blue_slope(timing=5, big_time=2, small_time=0.3, noise_range=1, isstop=False)

        #self.snow_ridge_line(timing=3, big_time=3, small_time=0.7, noise_range=1, isstop=True)
    ...
    def debug(self):
        #self.internal_mountain(timing=1, big_time=0.5, small_time=0.3, noise_range=3, isstop=True, start_point=int(sys.argv[1]))
        #self.line_of_mountain(timing=1, big_time=0.5, small_time=0.3, noise_range=1, isstop=True, start_point=int(sys.argv[1]))
        #self.blue_slope(timing=1, big_time=0.5, small_time=0.3, noise_range=1, isstop=True, start_point=int(sys.argv[1]))
        #self.snow_ridge_line(timing=1, big_time=0.5, small_time=0.3, noise_range=1, isstop=True, start_point=int(sys.argv[1]))
        #self.snow_ridge(timing=1, big_time=0.5, small_time=0.3, noise_range=1, isstop=True, start_point=int(sys.argv[1]))
        #self.snow_slope(timing=1, big_time=0.5, small_time=0.3, noise_range=1, isstop=True, start_point=int(sys.argv[1]))
        self.sky()
    ...
    def sky(self):
        ...
        for track_path in track_lst:
            print(*track_path)
            self.servoMotors[0].setAngle(52)
            self.servoMotors[1].setAngle(70)
            self.servoMotors[2].setAngle(70)
            self.servoMotors[3].setAngle(0)
            ...
            self.servoMotors[0].setAngle(track_path[0])
            self.servoMotors[1].setAngle(track_path[1]-2)
            self.servoMotors[2].setAngle(track_path[2]-2)
            self.servoMotors[3].setAngle(track_path[3])
            sleep(3)
